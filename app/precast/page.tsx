...
export const metadata: Metadata = {
  ...
  description:
    "Build a precast concrete home across Kenya, faster and more affordable than stone. By Gedo Holdings, NCA registered since 2018. Get a quote today.",
  openGraph: {
    title: "Precast Concrete Construction in Kenya | Gedo Holdings",
    description:
      "Build a precast concrete home across Kenya, faster and more affordable than stone. By Gedo Holdings, NCA registered since 2018. Get a quote today.",
      ...
      <section className="bg-white py-16 md:py-24">
        <div className="max-w-[1280px] mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Main large image: precast_01 (hero/main) */}
