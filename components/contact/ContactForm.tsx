...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center gap-4 py-16 text-center bg-paper rounded-lg border border-concrete-200 px-8">
        ...
        <p className="font-sans text-sm text-text-secondary max-w-[320px] leading-relaxed">
          ...
          urgent queries, call or WhatsApp us directly.
        </p>
        <button
          onClick={() => setSubmitted(false)}
          className="font-mono text-[0.7rem] uppercase tracking-[0.1em] text-royal-600 hover:text-royal-700 transition-colors"
        >
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="name" className="font-mono text-[0.65rem] uppercase tracking-[0.1em] text-text-secondary">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="phone" className="font-mono text-[0.65rem] uppercase tracking-[0.1em] text-text-secondary">
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="email" className="font-mono text-[0.65rem] uppercase tracking-[0.1em] text-text-secondary">
          Email Address
        </label>
        <input
          id="email"
      ...
      <div className="flex flex-col gap-1.5">
        <label htmlFor="message" className="font-mono text-[0.65rem] uppercase tracking-[0.1em] text-text-secondary">
